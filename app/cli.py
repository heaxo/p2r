...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dxf-target-size-1-mm", type=float, default=None, help="可选，目标尺寸1，不指定方向，单位 mm")
    parser.add_argument("--dxf-target-size-2-mm", type=float, default=None, help="可选，目标尺寸2，不指定方向，单位 mm")
