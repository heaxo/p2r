...
async def add_dataset_item(
    ...
    a4_orientation: Annotated[str | None, Form(description="A4纸方向：auto、landscape、portrait")] = "auto",
    plate_point_ratio: Annotated[str | None, Form(description="可选，用户指定钢板点比例坐标 ratio_x,ratio_y")] = None,
    paper_point_ratio: Annotated[str | None, Form(description="可选，用户指定A4纸点比例坐标 ratio_x,ratio_y")] = None,
...
async def upload_tasks(
    ...
    paper_user_point_ratio: Annotated[str | None, Form(description="可选，手动指定A4纸点，例如0.5,0.5")] = None,
    ...
    params = {
        ...
        "paper_user_point_ratio": paper_user_point_ratio,
        "paper_source": paper_source,
